          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            ...
            <div className="mt-8 lg:col-span-5">
              ...
              <Link
                ...
                className="mt-8 flex w-full items-center justify-center rounded-md bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 ring-1 ring-inset hover:ring-gray-200"
              >
                Book venue
              </Link>
